...
- For non-trivial tasks, start in Plan Mode and don't implement until the user approves the plan.
...
- 새 컴포넌트/UI 작성 시 → [docs/design.md](docs/design.md) (LogLife 색상·버튼 체계 + Meta 디자인 규칙 — 디자인 작업 시 필독)
